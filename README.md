...
` sh prep-fetal2.sh [RAW CASE DIR] [STUDY RECON DIR]`
...
6. Generate SVRTK docker run script
`sh svrtk-dock-gen.sh [recon dir]`
...
6. Load the SVRTK docker 
`sh docker_launch_svrtk.sh [STUDY RECON DIR]`
7. Navigate to the mounted data path and run the SVRTK run script
`cd /home/data
sh CASEID/nii/run-svrtk.sh`
-ALTERNATIVELY-
